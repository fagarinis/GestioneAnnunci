...
<body>
	<div class="container">
		...
		<div class="container-fluid">
			...
			<a href="${pageContext.request.contextPath}/areariservata/imieiannunci/ExecuteEliminaAnnuncioServlet?idAnnuncio=${annuncioAttr.id}" class="btn btn-info">Conferma Elimina Annuncio</a> 
